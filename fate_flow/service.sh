...
export PYTHONPATH=/data/projects/cos/standalone/standalone-fate-master-1.2.0
log_dir="$(echo ${PYTHONPATH} | awk -F":" '{print $1}')/logs"
venv=/data/projects/cos/standalone/standalone-fate-master-1.2.0/miniconda3-fate-1.1
