...
export PATH=${basepath}/miniconda3-fate-1.1/bin:\$PATH" > ${basepath}/miniconda3-fate-1.1/bin/activate
	...
	sed -i.bak "s#spring.datasource.url=.*#spring.datasource.url=jdbc:sqlite:$basepath/fate_flow/fate_flow_sqlite.db#g" ${basepath}/fateboard/conf/application.properties
